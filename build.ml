...
let targets = [
  ...
  "test-jpeg", {
    ...
    compilation_bytecode = true;
    compilation_native   = false;
    toplevel_modules     = "tests/test_jpeg.ml";
    package              = "unix,str,xml-light,zip";
    search_path          = ""; (* -I *)
    required_libraries   = "";
    compiler_flags       = "";
