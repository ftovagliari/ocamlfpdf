...
let targets = [
  ...
  "fpdf", {
    ...
    compilation_bytecode = true;
    compilation_native   = true;
    toplevel_modules     = "fpdf_javascript.ml fpdf_pack.ml fpdf_table.ml fpdf_barcode.ml fpdf_markup.ml fpdf_bookmark.ml fpdf_form.ml fpdf_tabular.ml";
    package              = "cpdf,str,unix,xml-light,zip";
    search_path          = "font"; (* -I *)
