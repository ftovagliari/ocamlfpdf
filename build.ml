...
let external_tasks = [
  ...
  5, (fun command -> {
    et_name                  = "findlib.ml dry";
    et_env                   = [];
    et_env_replace           = false;
    et_dir                   = "..";
    et_cmd                   = "ocaml";
    et_args                  = [true,"tools/findlib.ml"; true,"dry"];
    et_phase                 = None;
    et_always_run_in_project = false;
    et_always_run_in_script  = false;
    et_readonly              = true;
