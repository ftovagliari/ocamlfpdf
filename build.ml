...
let external_tasks = [
  ...
  0, (fun command -> {
    ...
    et_dir                   = "";
    et_cmd                   = "ocamldoc";
    et_args                  = [true,"*.mli"; true,"-d"; true,"../doc"; true,"-t"; true,"\"ocamlfpdf\""; true,"-html"; true,"-I"; true,"+site-lib/lablgtk2"; true,"-I"; true,"font"];
