...
and image 
and column = { mutable col_width : float; col_title : string; }
...
(** Table layout with automatic page break.
  ...
  @param cell_func Function applied to a single cell of the table to manage style properties.
         The [cell_properties] returned are applied to the cell identified by [index] and [col],
         where [index] is the general row index starting from [0].
