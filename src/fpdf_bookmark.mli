...
(**
  @param text The bookmark title. The title must be encoded in ISO-8859-1. Use {!Fpdf_util.utf8_to_utf16} for UTF-8.
...
*)
val add : ?text:string -> ?page:int -> ?y:float -> ?parent:index -> Fpdf.t -> index
